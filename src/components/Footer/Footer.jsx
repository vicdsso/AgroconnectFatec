        ...
        <footer className={style["footer-container"]}>
            <div className={style["content-container"]}>
                ...
                {/* <div className={style["item"]}>
                    ...
                    <p>O Agroconnect é seu portal para oportunidades no campo agricola. 
                        Parceiros podem anunciar ofertas, enquanto usuarios exploram soluções para 
                        suas necessidades agricolas.</p>
                </div>
                <div className={style["item"]}>
                ...
                <div className={style["item"]}>
                    ...
                    <p>Nossa abordagem:</p>
                    <ul>
                        <li>Centrado no Usuario: Facilitamos interações e transações.</li>
